 ...
 * <ul>
 *   <li>{@link featureModel.impl.ModelImpl#getRootFeature <em>Root Feature</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ModelImpl extends MinimalEObjectImpl.Container implements Model {
	...
	protected EClass eStaticClass() {
		return FeatureModelPackage.Literals.MODEL;
	}
	...
	public EList<Feature> getRootFeature() {
		if (rootFeature == null) {
			rootFeature = new EObjectContainmentEList<Feature>(Feature.class, this, FeatureModelPackage.MODEL__ROOT_FEATURE);
		}
		return rootFeature;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FeatureModelPackage.MODEL__ROOT_FEATURE:
